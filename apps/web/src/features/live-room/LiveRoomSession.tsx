      ...
      <div className="contents" inert={dialogOpen}>
        {grid.mode === "fullscreen" ? (
          ...
          <div
            ...
            className={`grid grow gap-3 overflow-y-auto px-4 pt-[calc(env(safe-area-inset-top)+12px)] pb-8 landscape:pl-[calc(env(safe-area-inset-left)+16px)] landscape:pr-[calc(env(safe-area-inset-right)+16px)] ${
