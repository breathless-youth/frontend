  ...
  return (
    ...
    >
      ...
      {showMedia && (
        ...
        <div
          ...
          className={cn(
            ...
            // 400ms·시트 곡선은 바 슬라이드(RoomControlBar)·타일 FLIP(LiveRoomSession)과
            // 도착 시점을 맞춘 값이다(2026-08-26 피드백) — 셋을 함께 바꿀 것.
            "transition-opacity duration-[400ms] ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
      ...
      <div
        ...
        className={cn(
          // 위 스크림과 같은 400ms·시트 곡선(바·FLIP과 도착 동기화) — 함께 바꿀 것.
          "absolute bottom-3 left-3 transition-opacity duration-[400ms] ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
          infoHidden && "opacity-0",
        )}
      >
