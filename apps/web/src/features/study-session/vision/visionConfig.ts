...
/**
 * 감김 비율을 재는 창의 표본 수 — 얼굴 틱 2초 × 30 = 60초.
 *
 * PERCLOS는 1994년 정의부터 1분 창이 표준이고 미 교통안전청과 후속 연구가 그대로 쓴다.
 * 대가는 깨어난 뒤 비율이 절반 아래로 내려오기까지 약 30초가 걸리는 것이다. 실기기에서 그
 * 꼬리를 잰다.
 */
export const EYE_RATIO_WINDOW_SAMPLES = 30;
